      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          ...
          <p className="mt-3 text-gray-400">
            A smart platform that connects citizens with local authorities to
            report, track, and resolve civic issues faster and transparently.
          </p>
        </motion.div>
        ...
        >
          ...
          <ul className="mt-3 space-y-2 text-gray-300">
            ...
            <li>
              <Link to="/track" className="hover:text-blue-400">
                Track Complaint
              </Link>
            </li>
          </ul>
